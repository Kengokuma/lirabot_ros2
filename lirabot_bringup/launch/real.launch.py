...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join('lirabot_bringup', 'rviz', 'nav2_view.rviz'),
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name', default_value='lirabot', description='name of the robot'
    )

    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(desc_dir, 'urdf', 'lirabot.xacro'),
